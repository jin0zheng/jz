...
input_name = 'shang_classify'  # 只需要修改这个
...
os.mkdir(output + '/' + input_name + '/img')
os.mkdir(output + '/' + input_name + '/txt')
...
for folder_name in folder_list:
    ...
    for img_name in img_list:
        shutil.copy(input_txt_path + '/' + input_name + '/' + folder_name + '/' + img_name[:-3] + 'txt',
                    output + '/' + input_name + '/txt/' + img_name[:-3] + 'txt')
        shutil.copy(input_img_path + '/' + input_name + '/' + folder_name + '/' + img_name,
                    output + '/' + input_name + '/img/' + img_name)
